...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %My_Nums, metadata !14, metadata !DIExpression()), !dbg !22
  call void @llvm.memset.p0.i64(ptr align 8 %c, i8 0, i64 8, i1 false), !dbg !23
  store i64 24, ptr %c, align 4, !dbg !23
  call void @llvm.dbg.declare(metadata ptr %c, metadata !24, metadata !DIExpression()), !dbg !25
  %"struct member ptr" = getelementptr inbounds %My_Nums, ptr %My_Nums, i32 0, i32 3, !dbg !26
  %selected = load i32, ptr %"struct member ptr", align 4, !dbg !26
  %4 = call i32 @change_a(i32 %selected), !dbg !26
  %"struct member ptr1" = getelementptr inbounds %My_Nums, ptr %My_Nums, i32 0, i32 3, !dbg !26
  store i32 %4, ptr %"struct member ptr1", align 4, !dbg !26
  call void @llvm.dbg.declare(metadata ptr %"struct member ptr1", metadata !27, metadata !DIExpression()), !dbg !28
  %"struct member ptr2" = getelementptr inbounds %My_Nums, ptr %My_Nums, i32 0, i32 3, !dbg !29
  %selected3 = load i32, ptr %"struct member ptr2", align 4, !dbg !29
  %5 = icmp eq i32 %selected3, 3, !dbg !29
  br i1 %5, label %if_true7, label %if_false, !dbg !30

if_false:                                         ; preds = %entry
  %"struct member ptr4" = getelementptr inbounds %My_Nums, ptr %My_Nums, i32 0, i32 3, !dbg !31
  %selected5 = load i32, ptr %"struct member ptr4", align 4, !dbg !31
  %6 = icmp eq i32 %selected5, 2, !dbg !31
  br i1 %6, label %if_true, label %if_false6, !dbg !32
...
if_true7:                                         ; preds = %entry
  call void @puts(ptr @0), !dbg !34
  ret i32 0, !dbg !30
}

declare void @puts(ptr)

define i32 @change_a(i32 %a) !dbg !35 {
entry:
  %a1 = alloca i32, align 4
  call void @llvm.memset.p0.i64(ptr align 4 %a1, i8 0, i64 4, i1 false)
  call void @llvm.dbg.declare(metadata ptr %a1, metadata !38, metadata !DIExpression()), !dbg !39
  store i32 %a, ptr %a1, align 4
  %0 = load i32, ptr %a1, align 4, !dbg !40
  %1 = sdiv i32 %0, 2, !dbg !40
  ret i32 %1, !dbg !40
}
...
!22 = !DILocation(line: 6, column: 2, scope: !8)
!23 = !DILocation(line: 7, scope: !8)
!24 = !DILocalVariable(name: "c", scope: !8, file: !1, line: 7, type: !5, align: 64)
!25 = !DILocation(line: 7, column: 2, scope: !8)
!26 = !DILocation(line: 8, scope: !8)
!27 = !DILocalVariable(scope: !8, file: !1, line: 8, type: !11, align: 32)
!28 = !DILocation(line: 8, column: 2, scope: !8)
!29 = !DILocation(line: 9, scope: !8)
!30 = !DILocation(line: 12, scope: !8)
!31 = !DILocation(line: 14, scope: !8)
!32 = !DILocation(line: 15, scope: !8)
!33 = !DILocation(line: 17, scope: !8)
!34 = !DILocation(line: 11, scope: !8)
!35 = distinct !DISubprogram(name: "change_a", scope: !1, file: !1, line: 23, type: !36, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !12)
!36 = !DISubroutineType(types: !37)
!37 = !{!11, !11}
!38 = !DILocalVariable(name: "a", scope: !35, file: !1, line: 23, type: !11)
!39 = !DILocation(line: 23, scope: !35)
!40 = !DILocation(line: 25, scope: !35)
