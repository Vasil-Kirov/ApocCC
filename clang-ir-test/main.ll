...
$"??_C@_0L@MFCAEIDC@number?5?$CFd?6?$AA@" = comdat any

@__const.main.my_arr = private unnamed_addr constant [4 x i32] [i32 1, i32 2, i32 3, i32 4], align 16
@"??_C@_0L@MFCAEIDC@number?5?$CFd?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [11 x i8] c"number %d\0A\00", comdat, align 1
...
define dso_local i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %1, ptr align 16 @__const.main.my_arr, i64 16, i1 false)
  %2 = getelementptr inbounds [4 x i32], ptr %1, i64 0, i64 0
  %3 = load i32, ptr %2, align 16
  %4 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0L@MFCAEIDC@number?5?$CFd?6?$AA@", i32 noundef %3)
  %5 = getelementptr inbounds [4 x i32], ptr %1, i64 0, i64 1
  %6 = load i32, ptr %5, align 4
  %7 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0L@MFCAEIDC@number?5?$CFd?6?$AA@", i32 noundef %6)
  %8 = getelementptr inbounds [4 x i32], ptr %1, i64 0, i64 2
  %9 = load i32, ptr %8, align 8
  %10 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0L@MFCAEIDC@number?5?$CFd?6?$AA@", i32 noundef %9)
  %11 = getelementptr inbounds [4 x i32], ptr %1, i64 0, i64 3
  %12 = load i32, ptr %11, align 4
  %13 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0L@MFCAEIDC@number?5?$CFd?6?$AA@", i32 noundef %12)
  %14 = getelementptr inbounds [4 x i32], ptr %1, i64 0, i64 4
  %15 = load i32, ptr %14, align 16
  %16 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0L@MFCAEIDC@number?5?$CFd?6?$AA@", i32 noundef %15)
  ret i32 0
}
